...
**NI-VISA and Thorlabs Optical Power Monitor** do not always coexist cleanly: installing or reinstalling one can break the other.  After NI-VISA is in place, **do not** reinstall Thorlabs Optical Power Monitor as a troubleshooting step—you might break PyVisa/NI-VISA communication as a result.
